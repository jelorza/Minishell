...
int	ft_exec(t_in *dt)
{
	...
	while (dt->l_parseCmd)//recorro la lista de comandos ejecutandolos
	{
		...
		dt->cmdf = ft_split(dt->l_parseCmd->data, 1);//OJO AQUI CON LOS ESPACIOS AFECTADOS POR COMILLAS. HAREMOS LA PROBATURA DE METER AQUI UN COMANDO NO IMPRIMIBLE PARA DIVIDIR LA LINEA!!!!!
